...
ucNowCityCODE: 'tn.monastir', // always lower-case !!!
...
// Note : ucBlinkingEnabled et ucStartPrayerBlinking sont dans JS_CUSTOM_DEFAULTS (custom.js)
// et ne doivent PAS figurer ici (règle d'or : jamais ajouter de clés custom dans JS_DATA).
